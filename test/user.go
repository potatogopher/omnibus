...
func ShowUserOK(t *testing.T, ctrl app.UserController, userID int) *app.AtlasUser {
	return ShowUserOKCtx(t, context.Background(), ctrl, userID)
}

// ShowUserOKCtx test setup
func ShowUserOKCtx(t *testing.T, ctx context.Context, ctrl app.UserController, userID int) *app.AtlasUser {
	var logBuf bytes.Buffer
	var resp interface{}
	respSetter := func(r interface{}) { resp = r }
	service := goatest.Service(&logBuf, respSetter)
	...
	a, ok := resp.(*app.AtlasUser)
	if !ok {
		t.Errorf("invalid response media: got %+v, expected instance of app.AtlasUser", resp)
	}
...
func ShowUserOKTiny(t *testing.T, ctrl app.UserController, userID int) *app.AtlasUserTiny {
	return ShowUserOKTinyCtx(t, context.Background(), ctrl, userID)
}

// ShowUserOKTinyCtx test setup
func ShowUserOKTinyCtx(t *testing.T, ctx context.Context, ctrl app.UserController, userID int) *app.AtlasUserTiny {
	var logBuf bytes.Buffer
	var resp interface{}
	respSetter := func(r interface{}) { resp = r }
	service := goatest.Service(&logBuf, respSetter)
	...
	a, ok := resp.(*app.AtlasUserTiny)
	if !ok {
		t.Errorf("invalid response media: got %+v, expected instance of app.AtlasUserTiny", resp)
	}
...
func ShowUserOKLink(t *testing.T, ctrl app.UserController, userID int) *app.AtlasUserLink {
	return ShowUserOKLinkCtx(t, context.Background(), ctrl, userID)
}

// ShowUserOKLinkCtx test setup
func ShowUserOKLinkCtx(t *testing.T, ctx context.Context, ctrl app.UserController, userID int) *app.AtlasUserLink {
	var logBuf bytes.Buffer
	var resp interface{}
	respSetter := func(r interface{}) { resp = r }
	service := goatest.Service(&logBuf, respSetter)
	...
	a, ok := resp.(*app.AtlasUserLink)
	if !ok {
		t.Errorf("invalid response media: got %+v, expected instance of app.AtlasUserLink", resp)
	}
